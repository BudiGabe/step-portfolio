...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeFullDay() {
    // Have an optional attendee C who has an all day event.
    // The same three time slots should be returned, as person C is optional and busy all day
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void optionalAttendeeEventThatFits() {
    // Have two mandatory attendees and one optional attendee.
    // Two options should be returned so that all optional and mandatory attendees can join.
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  @Test
  public void justEnoughRoomOnlyForMandatoryAttendees() {
    // Have one mandatory attendee and one optional attendee.
    // As person B is optional, they will be skipped, because their event doesn't leave
  ...
  public void onlyOptionalAttendeesWithGaps() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TIME_0800AM, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0930AM, TIME_1000AM, true),
            Arrays.asList(PERSON_A)),
